          ...
          <div className='row'>
              ...
              <div
                ...
                <div
                  ...
                  <p className='social-icon'>
                    <a
                      href='https://web.facebook.com/saqlainabid.jamali/'
                      target='_blank'
                  ...
                  <p className='social-icon'>
                    <a
                      href='https://www.linkedin.com/in/saqlain-abid-6b64981a7/'
                      target='_blank'
                      rel='noopener noreferrer'>
                      <FaLinkedinIn
                        style={{ fontSize: 20, color: "whitesmoke" }}
            ...
            <div className='col-md-4 '>
              <div
                ...
                <h5>Phone No</h5>
                <p>
                  <a href='tel:+923109310235'>0336-3270131</a>
                </p>
              </div>
            </div>
          </div>
